...
contract Token is Ownable {
    ...
    uint256 public _buyTaxPercentage;        //1000 = 1%
    uint256 public _sellTaxPercentage;       //1000 = 1%
    uint256 public _liquidityTaxPercentage;  //1000 = 1%
    uint256 public _burnTaxPercentage;       //1000 = 1%
    ...
    constructor( uint256 _tokenTotalSupply, string memory _tokenName, string memory _tokenSymbol, uint8 _tokenDecimals, uint256 _buyTax, uint256 _sellTax, uint256 _autoBurnPercetage, uint256 _autoLiquidityPercentage, address _taxWallet) {
        
        //update the variables
        _tokenTotalSupply = _tokenTotalSupply * (10**_tokenDecimals);
        _totalSupply = _tokenTotalSupply;
        _balances[tx.origin] = _tokenTotalSupply;
        _name = _tokenName;
        _symbol = _tokenSymbol;
        _decimals = _tokenDecimals;
        _buyTaxPercentage = _buyTax;
        _sellTaxPercentage = _sellTax;
        _liquidityTaxPercentage = _autoLiquidityPercentage;
        _burnTaxPercentage = _autoBurnPercetage;
    ...
    function swapAndLiquify() internal {
        ...
        if (contractTokenBalance >= _taxThreshold) {
            ...
            (success1,) = marketingWallet.call{value: totalAmount, gas: 35000}("");
